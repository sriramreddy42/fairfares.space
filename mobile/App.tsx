...
const styles = StyleSheet.create({
  ...
  listingSuccessCard: { width: "100%", maxWidth: 420, borderRadius: 28, borderWidth: 1, borderColor: "rgba(34,197,94,0.48)", backgroundColor: "#1b221f", paddingHorizontal: 22, paddingTop: 26, paddingBottom: 30, alignItems: "center", gap: 13 },
  ...
  listingSuccessTitle: { color: "#f7f7f8", fontSize: 25, lineHeight: 31, fontWeight: "900", textAlign: "center" },
  listingSuccessLocation: { color: "#d5ddd8", fontSize: 16, lineHeight: 22, fontWeight: "800", textAlign: "center" },
  listingSuccessFacts: { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 7 },
  listingSuccessFact: { color: "#f7f7f8", fontSize: 12, fontWeight: "900", overflow: "hidden", borderRadius: theme.radius.pill, borderWidth: 1, borderColor: "rgba(255,255,255,0.18)", backgroundColor: "rgba(255,255,255,0.08)", paddingHorizontal: 10, paddingVertical: 6 },
  listingSuccessCopy: { color: "#c2cec8", fontSize: 13, lineHeight: 19, fontWeight: "700", textAlign: "center", marginTop: 1, marginBottom: 7 },
  listingSuccessShare: { width: "100%", minHeight: 50, borderRadius: theme.radius.pill, borderWidth: 1.4, borderColor: "rgba(65,141,255,0.82)", alignItems: "center", justifyContent: "center", marginTop: 1, backgroundColor: "rgba(65,141,255,0.08)" },
  listingSuccessShareText: { color: "#f4f8ff", fontSize: 14, fontWeight: "900" },
  listingSuccessPrimary: { width: "100%", minHeight: 66, borderRadius: theme.radius.pill, backgroundColor: theme.colors.green, alignItems: "center", justifyContent: "center", marginTop: 8, shadowColor: theme.colors.green, shadowOpacity: 0.30, shadowRadius: 16, shadowOffset: { width: 0, height: 9 }, elevation: 5 },
  listingSuccessPrimaryText: { color: "#06140d", fontSize: 18, fontWeight: "900" },
