...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: "#4ade80", fontSize: 10, letterSpacing: 1.1, fontWeight: "700" }, title: { color: theme.colors.text, fontSize: 21, fontWeight: "700" }, content: { padding: 14, paddingBottom: 48, gap: 12, width: "100%", maxWidth: 760, alignSelf: "center" },
  ...
  card: { borderWidth: 1, borderColor: theme.colors.line, backgroundColor: theme.colors.panel, borderRadius: 18, padding: 14, gap: 8 }, centerCard: { margin: 14, borderWidth: 1, borderColor: theme.colors.line, backgroundColor: theme.colors.panel, borderRadius: 18, padding: 20, gap: 8 }, rowBetween: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }, flex: { flex: 1, minWidth: 0 },
