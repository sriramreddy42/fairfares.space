...
const styles = StyleSheet.create({
  ...
  title: { color: theme.colors.text, fontSize: 42, fontWeight: "900", letterSpacing: 0 },
  sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: theme.spacing.sm },
  sectionTitle: { color: theme.colors.text, fontSize: 24, fontWeight: "900" },
  ...
  noticeTitle: { color: theme.colors.text, fontSize: 24, fontWeight: "900" },
  ...
  primaryPillText: { color: "#fff", fontWeight: "900", fontSize: 16 },
  ...
  emptyCopy: { color: theme.colors.muted, fontSize: 16, fontWeight: "800", marginTop: 4 },
  emptyIconBox: { width: 52, height: 52, borderRadius: 18, backgroundColor: theme.colors.panel2, alignItems: "center", justifyContent: "center" },
  ...
  cardTitle: { color: theme.colors.text, fontSize: 20, fontWeight: "900" },
  ...
  rowIcon: { width: 58, height: 58, borderRadius: theme.radius.sm, backgroundColor: theme.colors.panel2, alignItems: "center", justifyContent: "center" },
