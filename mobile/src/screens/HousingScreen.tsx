...
const styles = StyleSheet.create({
  ...
  ridePopularTitle: { color: theme.colors.text, fontSize: 20, lineHeight: 24, fontWeight: "900" },
  ...
  rideComingSoonTitle: { color: theme.colors.text, fontSize: 18, lineHeight: 22, fontWeight: "900", marginTop: 3 },
  ...
  ridePosterTitle: { color: theme.colors.text, fontSize: 19, lineHeight: 23, fontWeight: "900" },
  ridePosterSubtitle: { color: "rgba(255,255,255,0.78)", fontSize: 12, lineHeight: 16, fontWeight: "800" },
  ...
  rideSimpleTrust: { color: theme.colors.green, fontSize: 12, fontWeight: "800" },
  rideSimpleSteps: { flexDirection: "row", gap: 10, marginTop: 2 },
  rideSimpleStep: { flex: 1, minHeight: 82, borderRadius: 16, backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.07)", paddingHorizontal: 9, paddingVertical: 12, alignItems: "center", justifyContent: "center", gap: 8 },
  rideSimpleStepText: { color: theme.colors.soft, fontSize: 12, lineHeight: 16, fontWeight: "800", textAlign: "center" },
  ...
  rideFindButtonText: { color: "#64b5ff", fontSize: 15, fontWeight: "800" },
  ...
  rideOfferButtonText: { color: theme.colors.text, fontSize: 15, fontWeight: "800" },
