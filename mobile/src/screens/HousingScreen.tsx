...
const styles = StyleSheet.create({
  ...
  rideSearchLoadingCard: { width: "100%", maxWidth: 340, paddingHorizontal: 24, paddingVertical: 20, alignItems: "center", gap: 10 },
  ...
  rideSearchLoadingPromo: { width: 118, height: 79, borderRadius: theme.radius.sm, marginTop: 6 },
