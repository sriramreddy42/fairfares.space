...
const styles = StyleSheet.create({
  ...
  housingIntentCard: { width: "48.3%", minHeight: 106, borderRadius: 18, borderWidth: 1, borderColor: "rgba(255,255,255,0.78)", padding: 10, overflow: "hidden", shadowColor: "#101828", shadowOpacity: Platform.OS === "android" ? 0 : 0.10, shadowRadius: 14, shadowOffset: { width: 0, height: 8 }, elevation: 2 },
