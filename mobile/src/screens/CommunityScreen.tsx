  ...
  return <View style={styles.screen}>
    ...
    <Modal visible={guestBenefitsOpen} transparent animationType="fade" onRequestClose={() => setGuestBenefitsOpen(false)}>
      <View style={styles.guestBenefitsBackdrop}><View style={styles.guestBenefitsCard}>
        ...
        <TouchableOpacity style={styles.guestBenefitsPrimary} onPress={() => { setGuestBenefitsOpen(false); onRequireSignup(); }}><Text style={styles.guestBenefitsPrimaryText}>Create free account</Text></TouchableOpacity>
        <TouchableOpacity style={styles.guestBenefitsSecondary} onPress={() => { setGuestBenefitsOpen(false); onRequireLogin(); }}><Text style={styles.guestBenefitsSecondaryText}>Already registered? Log in</Text></TouchableOpacity>
      </View></View>
    </Modal>
  </View>;
}
