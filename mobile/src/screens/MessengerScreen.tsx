...
const styles = StyleSheet.create({
  ...
  messageMediaStackLayer: { ...StyleSheet.absoluteFillObject, borderRadius: 18, backgroundColor: "#F8FAF9", borderWidth: 1, borderColor: "rgba(255,255,255,0.94)", shadowColor: "#000", shadowOpacity: 0.2, shadowRadius: 7, shadowOffset: { width: 0, height: 3 }, elevation: 4 },
  messageMediaStackBack: { transform: [{ translateX: 27 }, { translateY: -13 }], opacity: 1 },
  messageMediaStackMiddle: { transform: [{ translateX: 14 }, { translateY: -7 }], opacity: 1 },
