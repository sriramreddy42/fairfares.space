...
const styles = StyleSheet.create({
  ...
  chatOptionText: { color: "#242424", fontSize: 14, fontWeight: "800" },
  ...
  dateDividerText: { color: "rgba(255,255,255,0.72)", fontSize: 11, fontWeight: "900", letterSpacing: 1.8 },
  ...
  quickReplyText: { color: "#8db0ff", fontSize: 14, fontWeight: "900" },
  ...
  attachmentPanelTitle: { color: "#242424", fontSize: 15, fontWeight: "900" },
  ...
  pendingAttachmentName: { color: "#17202d", fontSize: 13, fontWeight: "900" },
  ...
  fileCardCopy: { flex: 1 },
  fileCardName: { color: "#17202d", fontSize: 13, lineHeight: 17, fontWeight: "900" },
  ...
  richEyebrow: { color: "#087f72", fontSize: 10, letterSpacing: 0.8, fontWeight: "900" },
  richTitle: { color: "#17202d", fontSize: 16, lineHeight: 20, fontWeight: "900" },
  ...
  senderName: { color: "#17202d", fontSize: 12, fontWeight: "900" },
  ...
  messageContextType: { fontSize: 10, fontWeight: "900", textTransform: "uppercase", letterSpacing: 0.6, marginBottom: 3 },
  myMessageContextType: { color: "#e4f7ff" },
  theirMessageContextType: { color: "#087f72" },
  messageContextTitle: { fontSize: 13, lineHeight: 17, fontWeight: "900" },
